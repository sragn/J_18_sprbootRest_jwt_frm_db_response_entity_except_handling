...
//                    response = ResponseEntity.class)
    public ResponseEntity<Object> getCloudVendorDetails(@PathVariable("vendorId") String vendorId)
    {
       return ResponseHandler.responseBuilder("Requested Vendor Details are given here",
                HttpStatus.OK, cloudVendorService.getCloudVendor(vendorId),"1");
    }
	...
	/*
	 * @GetMapping("/{vendorName}") public String
	 * getCloudVendorDetails(@PathVariable("vendorName") String vendorName) {
	 * cloudVendorService.getByVendorName(vendorName); return
